...
int main()
{
    ...
    turtle_flower.to_cylinder(0.1, 8, pts, faces_flower);
    ...
    // turtle_bush.create_obj_file("output/3d/no_edge_bush.obj", pts_bush, faces_bush);
    ...
    // auto generated_param = lsys_param.generate(1);
    ...
    // turtle_param.create_obj_file("output/3d/no_edge_param.obj", pts_param, faces_param);
    // turtle_param.to_cylinder(0.1, 8, pts_param, faces_param);
    ...
    // turtle_hilbert.create_obj_file("output/3d/no_c_hilbert.obj", pts_hilbert, faces_hilbert);
    // turtle_hilbert.to_cylinder(0.1, 8, pts_hilbert, faces_hilbert);
    ...
    // auto pts_cylinder = turtle_cylinder.compute(core::State{
    //                                                 {core::Module{'F', {10}},
    //                                                 core::Module{'+', {pi / 2}},
    //                                                 core::Module{'F', {5}},
    //                                                 }}, "", faces_cylinder);
